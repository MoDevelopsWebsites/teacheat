...
const Founders: React.FC = () => {
  return (
    <div className="relative flex flex-col items-center min-h-screen bg-gradient-to-br from-landing-background-start to-landing-background-end text-landing-text-primary overflow-hidden">
      ...
      <div
        className="absolute top-0 left-0 w-full h-screen bg-cover bg-center z-0" // Changed height to h-screen
        style={{
          backgroundImage: `url(${import.meta.env.BASE_URL + "wallpaper9.jpeg"})`,
          maskImage: 'linear-gradient(to bottom, black 50%, transparent 90%)', // Adjusted fade gradient
          WebkitMaskImage: 'linear-gradient(to bottom, black 50%, transparent 90%)', // Adjusted fade gradient
          opacity: 0.7,
          filter: 'blur(4px)',
        }}
      ></div>
