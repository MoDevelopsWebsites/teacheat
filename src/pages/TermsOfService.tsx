  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 max-w-4xl mt-20 sm:py-16 sm:mt-24"> {/* Adjusted padding and margin for mobile */}
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-center mb-8 sm:mb-12">Terms of Service</h1> {/* Adjusted text sizes and margin for mobile */}

        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">1. Acceptance of Terms</h2> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">2. Description of Service</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">3. User Accounts</h2> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">4. Acceptable Use</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">5. Intellectual Property</h2> {/* Adjusted text sizes and margin for mobile */}
          <ul className="list-disc list-inside ml-4 mb-3 sm:mb-4 space-y-1 text-sm sm:text-base"> {/* Adjusted margin/spacing/text size for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">6. Privacy Policy</h2> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">7. Disclaimers</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">8. Limitation of Liability</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">9. Indemnification</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">10. Termination</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">11. Governing Law</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">12. Changes to These Terms</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">13. Contact Us</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
