  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-grow container mx-auto px-4 py-16 max-w-4xl mt-24"> {/* Add mt-24 to main */}
        <h1 className="text-4xl md:text-5xl font-extrabold text-center mb-12">Privacy Policy</h1>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-xl font-semibold mb-2">2.2. Information Collected Through Your Use of the Service</h3>
          <ul className="list-disc list-inside ml-4 mb-4 space-y-1">
