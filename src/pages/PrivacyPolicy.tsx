...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 max-w-4xl mt-20 sm:py-16 sm:mt-24"> {/* Adjusted padding and margin for mobile */}
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-center mb-8 sm:mb-12">Privacy Policy</h1> {/* Adjusted text sizes and margin for mobile */}

        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">1. Introduction</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
          ...
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
            By using the Service, you agree to the collection and use of information in accordance with this policy.
          </p>
        </section>

        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">2. Information We Collect</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
            We collect various types of information to provide and improve our Service to you.
          </p>
          <h3 className="text-lg sm:text-xl font-semibold mb-2">2.1. Information You Provide Directly</h3> {/* Adjusted text sizes and margin for mobile */}
          <ul className="list-disc list-inside ml-4 mb-3 sm:mb-4 space-y-1 text-sm sm:text-base"> {/* Adjusted margin/spacing/text size for mobile */}
          ...
          <h3 className="text-lg sm:text-xl font-semibold mb-2">2.2. Information Collected Through Your Use of the Service</h3> {/* Adjusted text sizes and margin for mobile */}
          <ul className="list-disc list-inside ml-4 mb-3 sm:mb-4 space-y-1 text-sm sm:text-base"> {/* Adjusted margin/spacing/text size for mobile */}
            <li><strong>Meeting Content (Audio & Screen):</strong> Teacheat is designed to listen to your meetings and observe your screen content locally on your device to provide real-time AI assistance, take notes, and offer suggestions. This raw meeting content (audio, visual data from your screen) is primarily processed locally on your device. We do not transmit raw, unanonymized meeting audio or screen content to our servers or third-party AI models without your explicit consent or if it's necessary to fulfill a specific feature you've enabled (e.g., sending a specific prompt to an AI model).</li>
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">3. How We Use Your Information</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">4. How We Share Your Information</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
          ...
          <p className="mt-3 sm:mt-4 text-sm sm:text-base"> {/* Adjusted margin/text size for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">5. Data Retention</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">6. Your Data Protection Rights</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="mb-3 sm:mb-4 text-sm sm:text-base"> {/* Adjusted text sizes and margin for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">7. Data Security</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">8. Children's Privacy</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">9. Changes to This Privacy Policy</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
        ...
        <section className="mb-6 sm:mb-8"> {/* Adjusted margin for mobile */}
          <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">10. Contact Us</h2> {/* Adjusted text sizes and margin for mobile */}
          <p className="text-sm sm:text-base"> {/* Adjusted text sizes for mobile */}
            If you have any questions about this Privacy Policy, please contact us:
          </p>
          <ul className="list-disc list-inside ml-4 space-y-1 text-sm sm:text-base"> {/* Adjusted margin/spacing/text size for mobile */}
