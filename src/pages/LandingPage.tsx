    ...
    <div className="relative flex flex-col min-h-screen bg-gradient-to-b from-landing-background-start to-landing-background-end text-landing-text-primary overflow-hidden">
      ...
      <main className="flex-grow flex flex-col items-center">
        <section className="relative flex flex-col items-center text-center px-4 py-16 max-w-4xl z-10 mt-12">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-normal leading-tight mb-6 text-white font-display">
            <span className="text-7xl md:text-8xl">#1</span> AI assistant <br /> for meetings
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl text-white font-normal mb-10 max-w-2xl">
