...
const QuickJoinWaitlistSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full py-16 sm:py-20 bg-black text-white rounded-t-3xl overflow-hidden">
      {/* Background pattern */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-base md:text-lg text-gray-400 mb-6 sm:mb-10 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 max-w-md mx-auto">
          <Input
            ...
            className="flex-grow px-4 rounded-md border border-gray-700 bg-gray-800 text-white placeholder:text-gray-500 focus:ring-0 focus:border-blue-500 h-10"
            value={email}
            onChange={(e) => setEmail(e.target.value)}
            disabled={isLoading}
          />
          <Button
            className="bg-white text-gray-900 hover:bg-gray-200 rounded-md px-6 h-10 text-base font-medium shadow-md"
