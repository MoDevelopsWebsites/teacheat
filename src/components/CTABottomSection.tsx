...
const CTABottomSection: React.FC = () => {
  return (
    <section className="relative w-full py-24 bg-gradient-to-br from-landing-cta-background-start to-landing-cta-background-end text-landing-cta-text-primary overflow-hidden">
