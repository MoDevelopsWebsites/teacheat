...
import QuickJoinWaitlistSection from './QuickJoinWaitlistSection'; // Import the new component

const Footer: React.FC = () => {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="w-full bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300">
      <QuickJoinWaitlistSection /> {/* Render the new section here */}
      <div className="py-12 px-6 border-t border-gray-100 dark:border-gray-800 mt-12"> {/* Added mt-12 here */}
