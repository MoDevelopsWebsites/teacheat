    ...
    <Card className="relative w-full max-w-5xl h-auto md:h-[600px] bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="flex-grow flex flex-col p-4 md:p-6 overflow-y-auto">
        ...
        <CardHeader className="p-0 mb-4 md:mb-6">
          <CardTitle className="text-xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1 md:mb-2">
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col">
            <div className="flex flex-wrap gap-4 mb-4">
              <div className="flex flex-col">
                ...
                <span className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">2</span>
              </div>
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Missed opportunities</span>
                <span className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">6</span>
              </div>
            </div>

            <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-2">Summary</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 text-sm space-y-1 mb-4 md:mb-6">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-2">Action items</h3>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 text-sm space-y-1">
              <li>Send Mrs. Rivera the intake form, pricing information, and short videos</li>
            </ul>
          </div>

          <div className="col-span-1 md:border-l border-gray-200 dark:border-gray-700 md:pl-6 pt-4 md:pt-0 flex flex-col">
